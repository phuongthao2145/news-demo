                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Result: <?php echo count($searchCount) ?> item(s)</h4>
                    ...
                    <?php endforeach ?>
                    <div class="pagination offset-7 mt-3">
                        <?php echo $item->paginate($url, $total, $page, $count, 2) ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
